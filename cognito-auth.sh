...
#
username="[your user's email address]"
password="[your users password]"
clientid="[cognito client app id]"
region="af-south-1" #check this matches the region you deploy to
aws_profile="[name of local AWS credentials profile you created for AWS CLI tool]"
